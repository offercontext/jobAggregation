...
- [ ] **Step 1: Capture the baseline from the fixed commit without modifying it**
...
- [ ] **Step 2: Write immutable-asset and RED source gates**
...
- [ ] **Step 3: Run the gates and verify RED for missing convergence code**
...
- [ ] **Step 4: Commit the reviewed fixtures and RED gates**
...
- [ ] **Step 4: Run focused tests and the asset gate**
...
- [ ] **Step 5: Commit contracts and registry**
...
- [ ] **Step 1: Write failing controller and Strict Mode tests**
...
- [ ] **Step 3: Implement a pure reducer-backed controller and accessible host**
...
- [ ] **Step 1: Add failing API tests for latest Note, pagination and fields**
...
- [ ] **Step 3: Implement one shared unique-Event statement**
...
- [ ] **Step 4: Verify backend GREEN and contract serialization**
...
- [ ] **Step 5: Commit the controlled read-contract change**
...
- [ ] **Step 1: Write the complete failing truth-table tests**
...
- [ ] **Step 3: Implement the closed normalizer and classifier**
...
- [ ] **Step 4: Verify lifecycle GREEN and TypeScript**
...
- [ ] **Step 3: Implement immutable snapshot resolution**
...
- [ ] **Step 5: Commit Application resolution**
...
- [ ] **Step 1: Write failing composition and ownership tests**
...
- [ ] **Step 3: Integrate the controller at the composition root**
...
- [ ] **Step 4: Verify composition GREEN and zero duplicate transport**
...
- [ ] **Step 5: Commit the single-owner Application composition**
...
- [ ] **Step 1: Write failing owner, history and safe-copy tests**
...
- [ ] **Step 2: Run Fit tests and verify RED**
...
- [ ] **Step 3: Implement the single owner and read-only projection**
...
- [ ] **Step 4: Verify Fit GREEN and unchanged service requests**
...
- [ ] **Step 5: Commit Opportunity Fit cutover**
...
- [ ] **Step 1: Write failing state/action and lease tests**
...
- [ ] **Step 3: Implement pure projections and preserve mutation handlers**
...
- [ ] **Step 4: Verify Material GREEN and service goldens**
...
- [ ] **Step 5: Commit Material Kit convergence**
...
- [ ] **Step 1: Write failing event-card and chooser tests**
...
- [ ] **Step 3: Render only lifecycle-projected cards and exact handoffs**
...
- [ ] **Step 4: Verify Interview GREEN and event consumer gate**
...
- [ ] **Step 5: Commit Interview Event Surface**
...
- [ ] **Step 1: Write failing eligibility and projection tests**
...
- [ ] **Step 3: Implement fail-closed classifiers and route projections**
...
- [ ] **Step 1: Write failing lineage and cross-entry label tests**
...
- [ ] **Step 2: Run focused Resume tests and verify RED**
...
- [ ] **Step 3: Implement pure lineage and label mappers**
...
- [ ] **Step 1: Add failing negative fixtures for every mechanical rule**
...
- [ ] **Step 2: Run gates and verify RED against remaining legacy code**
...
- [ ] **Step 3: Delete the legacy paths instead of adding fallback facades**
...
- [ ] **Step 4: Verify all mechanical gates GREEN**
...
- [ ] **Step 5: Commit the one-way cutover gates**
...
- [ ] **Step 2: Run the full supported release gate with fresh output**
...
- [ ] **Step 3: Run the real browser acceptance matrix**
...
- [ ] **Step 4: Request independent CR and close all P0/P1/P2 findings**
...
- [ ] **Step 5: Write and verify the release report**
...
- [ ] **Step 6: Commit the verified report and checked plan**
